    ...
    <>
      ...
      <div className="flex ml-20 ">
        <div className="w-[1050px] h-[545px]">
          <div className="w-[350px] h-[321px] ml-36 mt-10">
            ...
            <button className="bg-blue-500 text-white px-6 py-3 rounded font-medium w-max mt-8">
              Get Quote Now
            </button>
          </div>
          <div>
      ...
      <div className="flex ml-36 mt-2">
        <div className="ml-8">
          ...
          <h2 className="text-[#252B42] w-[394px] h-[96px]">
            Met minim Mollie non desert Alamo est sit cliquey dolor do met sent.
          </h2>
        </div>
        <div>
          <p className="text-[#737373] w-[450px] h-[96px]">
