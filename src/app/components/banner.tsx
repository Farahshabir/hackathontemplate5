...
export default function Banner (){
 ...
 <div className="relative">
  {/* Image Banner */}
  <Image src={banner} alt="Banner Image" className="w-full h-auto object-cover" />

  {/* Content Overlay */}
  <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-white text-left p-8">
    <p className="text-sm md:text-2xl font-semibold -ml-96 mb-4">SUMMER 2020</p>
    <h1 className="text-4xl md:text-5xl font-bold mb-4 -ml-80">NEW COLLECTION</h1>
