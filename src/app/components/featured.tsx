            ...
            <div className="border-solid border-2 border-slate-200 shadow-md">
              ...
              <div className="flex">
                    <div className="flex mt-6">
                        <div className="ml-2 text-xl"><span className="text-[#8EC2F2]"><BiAlarm /></span></div>
                        <div className="mb-3"><p className="text-[#737373] text-sm">22 April 2021</p></div>
                        <div className="ml-8 text-xl"><span className="text-[#23856D]"><FaChartArea /></span></div>
                        <div><p className="text-[#737373] text-sm">10 comments</p></div>
                    </div>
              </div>
              <div className="flex">
                <div className="ml-3 text-[#737373]"><p>Learn More</p></div>
                <div className="text-[#23A6F0] text-xl ml-1 mt-1"><span><IoIosArrowForward /></span></div>
              </div>
            </div>
          </div>
          <div className="w-[348px] h-[600px] ">
